<template>
    <div class="roleView">
        <div class="container">
            <fieldset>
                <legend>Registro de  Roles</legend>
...
export default {
    ...
    methods: {
        ...
        findByid: function (id) {
            ...
            axios.get('http://132.145.204.101:8080/api/security/role/' + id).then(result => {
        ...
        deleteById: function (id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.delete('http://132.145.204.101:8080/api/security/role/' + id,).then(() => {
                        this.loadData();
                        this.clearList();
                    });
                }
        ...
        addData: function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.post('http://132.145.204.101:8080/api/security/role', data).then(result => {
                        if (result.data) {
                            this.loadData();
                            this.clearList();
                        }
        ...
        dataUpdate: function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.put('http://132.145.204.101:8080/api/security/role/' + this.id, data).then(result => {
                        if (result.data) {                            
                            this.loadData();
                            this.clearList();
                        }
